...
import org.springhibernatemvc.app.entity.Token;  
...
public class TokenDAOImpl implements TokenDAO  {  
    ...
    public boolean updateToken(String email, String authenticationToken, String secretKey) {  
        ...
        {  
            ...
            theQuery = session.createQuery("Update Token set authenticationToken = :authenticationToken , secretKey = :secretKey where email =:userEmail ");  
    ...
    public int getTokenDetail(String email) {  
        ...
        {  
            session = sessionFactory.getCurrentSession();  
            Query<Token> query = session.createQuery("from Token where email =:userEmail");  
    ...
    public int tokenAuthentication(String token, int email) {  
        Session session = null;  
